...
//   );
      ...
      <AppBar position="fixed" color="primary" className={classes.appBar}>
        <Toolbar>
          {/* <IconButton edge="start" color="inherit" aria-label="open drawer" onClick={toggleDrawer("left", true)}>
            ...
            <Link to="/mememainpage" style={{ textDecoration:"none",color:"white",marginLeft:0 }}>
            ...
            <Link to="/stickermainpage" style={{ textDecoration:"none",color:"white",marginLeft:13 }}>
              <Typography variant="subtitle1">
             STICKERS
            </Typography>
            </Link>
  ...
  export default RandomGifFooter;