...
function StickerMainPageFooter() {
            ...
            <React.Fragment>
                ...
                <AppBar position="fixed" color="primary" className={classes.appBar}>
                    <Toolbar>
                        ...
                        <NavLink to="/mememainpage" style={{ marginRight: 7, marginLeft: 3, textDecoration: "none", color: "white" }}>
                            <Typography variant="subtitle2" >
                                CREATE MEME
                            </Typography>
                        </NavLink>
...
export default StickerMainPageFooter;